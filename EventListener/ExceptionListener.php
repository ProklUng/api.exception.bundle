...
namespace Prokl\ApiExceptionBundle\EventListener;

use Symfony\Component\HttpKernel\Event\ExceptionEvent;
use Symfony\Component\HttpFoundation\JsonResponse;
use Symfony\Component\HttpKernel\Exception\HttpExceptionInterface as SymfonyHttpExceptionInterface;
use Prokl\ApiExceptionBundle\Manager\ExceptionManager;
use Prokl\ApiExceptionBundle\Exception\Interfaces\ExceptionInterface;
use Prokl\ApiExceptionBundle\Exception\Interfaces\HttpExceptionInterface;
use Prokl\ApiExceptionBundle\Exception\Interfaces\FlattenErrorExceptionInterface;
use Throwable;

/**
 * Class ExceptionListener
 * @package Prokl\ApiExceptionBundle\EventListener
 */
class ExceptionListener
{
    /**
